...
var publicTaskList = (function () {
     ...
     */
    function _baseURL() {
        return dcrc_lib.baseUrl() + 'publicTaskList/';
    }
...
$(document).ready(function () {
    publicTaskList.filterApplicationList();
    if($('#roleId').val()=="26079") {
        publicTaskList.getNDITaskList();
    }else if($('#roleId').val()=="26053"){

    }else{
        publicTaskList.getGroupTaskList('', '', 0, true);
    }
    publicTaskList.claimTaskFromList();
    publicTaskList.releaseTaskFromList();
    publicTaskList.redirectToSubmittedApplication();
    publicTaskList.redirectToRejectedApplication();
    publicTaskList.showNDIDetails();
});