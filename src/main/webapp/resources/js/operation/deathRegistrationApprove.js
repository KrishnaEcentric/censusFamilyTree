...
var deathRegistrationApprove = (function () {
    "use strict";
     ...
     */
    function _baseURL() {
        return dcrc_lib.baseUrl() + 'deathRegistrationApprove/';
    }
    ...
    function updateReject(applicationNo){
        if(validateReject()){
            var url= '/deathRegistrationApprove/updatereject?applicationNo='+applicationNo;
            window.open(url,'_blank');
        }
    }
    function approveApplication(applicationNo){
        var url = _baseURL+'approveDeathRegistration?applicationNo='+applicationNo;
        var options = {target:'#content_main_div',url:url,type:'GET', data: $('#deathRegistrationDetailsApproveForm').serialize()};
        $("#deathRegistrationDetailsApproveForm").ajaxSubmit(options);
...
//        window.open(url,'_blank');
    ...
    function verify(){
        ...
        $('#verifyId').on('click', function (e) {
            ...
            var url= _baseURL()+'approveDeathRegistration?applicationNo='+applicationNo+'&remarks='+remarks+'&statusName='+statusName;
            window.location=url;
        })
    }
...
$(document).ready(function () {
    ...
    deathRegistrationApprove.getIndividualInformation();
    deathRegistrationApprove.nextTab();
    deathRegistrationApprove.previousTab();
    deathRegistrationApprove.save();
    deathRegistrationApprove.approve();
    deathRegistrationApprove.verify();
    deathRegistrationApprove.sendBack();
    deathRegistrationApprove.resubmit();
    deathRegistrationApprove.reject();
    deathRegistrationApprove.getApplicationDetails();
