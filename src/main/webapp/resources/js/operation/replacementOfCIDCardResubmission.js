...
var replacementOfCIDCardResubmission = (function () {
    "use strict";
    ...
    var replacementOfCIDCardDetailsResubmission = $('#replacementOfCIDCardDetailsResubmission');
     ...
     */
    function _baseURL() {
        return dcrc_lib.baseUrl() + 'replacementOfCIDCardResubmission/';
    }
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            if (res.status == 1) {
                                ...
                                replacementOfCIDCardDetailsResubmission.removeClass('hidden');
                                _getIndividualInformation(cidSrpNoID.val());
                            } else if (res.status == 5) {
                                cidSrpNoID.val('');
                                changeSpouseInfoHeader.removeClass('hidden');
                                replacementOfCIDCardDetailsResubmission.addClass('hidden');
                                warningMsg(res.text);
                            } else {
                                errorMsg(res.text)
                            }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 1) {
                    ...
                    populate(res.dto.replacementOfCIDCardDTO);

                    $('#lastIssueDate').val(res.dto.lastCIDissueDate);
                    $('#lastExpiryDate').val(res.dto.lastCIDexpiryDate);
                    $('#mailingAddress').val(res.dto.replacementOfCIDCardDTO.mailingAddress);
                    $('#presentVillageSerialNo').val(res.dto.replacementOfCIDCardDTO.presentVillageSerialNo);
                    $('.reset').val('');
                    $('.fatherDetails').val('');
                    $('.motherDetails').val('');
                    $('.hohDetails').val('');
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 1) {
                    ...
                    $('#lastIssueDate').val(formatAsDate(res.dto.citizenDetails.lastIssueDate));
                    $('#lastExpiryDate').val(formatAsDate(res.dto.citizenDetails.lastExpiryDate));
                    $('.reset').val('');
                    $('.fatherDetails').val('');
                    $('.motherDetails').val('');
                    $('.hohDetails').val('');
    ...
    function nextTab() {
        $('.btnNext').on('click', function () {
            ...
            switch (nextButton) {
                case 'btnPersonalDetailsNextRCID':
                ...
                case 'btnPlaceOfBirthNextRCID':
                    ...
                    break;
                case 'btnPermanentAddressNextRCID':
                    ...
                    break;
                case 'btnPresentAddressNextRCID':
                    ...
                    break;
                case 'btnFathersDetailsNextRCID':
        ...
        $('.btnPrevious').on('click', function () {
            ...
            switch (previousButton) {
                case 'btnPlaceOfBirthPrevRCID':
                    ...
                    break;
                case 'btnPermanentAddressPrevRCID':
                    $('#placeOfBirthContent').prop('class', 'tab-pane active');
                    ...
                    break;
                case 'btnPresentAddressPrevRCID':
                    $('#permanentAddressContent').prop('class', 'tab-pane active');
                    ...
                    break;
                case 'btnFathersDetailsPrevRCID':
                    $('#presentAddressContent').prop('class', 'tab-pane active');
    ...
    function saveResubmission() {
        $('#btnSaveRCID').on('click', function () {
            $('#replacementOfCIDCardDetailsFormResubmission').validate({
                submitHandler: function (form) {
                    if (isSubmitted) {
                    ...
                    $('#btnSaveRCID').attr('disabled', true);
                    var firstNameBh = $('#firstNameBh').val();
                    isSubmitted = true;
                    $.ajax({
                        url: _baseURL() + 'saveResubmission?applicationNumber='+$('#applicationNumber').val() + '&firstNameBh='+firstNameBh,
                        type: 'POST',
                        ...
                        success: function (res) {
                            ...
                            $('#btnSaveRCID').attr('disabled', false);
                            isSubmitted = false;
                        }
                    });
                }
...
$(document).ready(function () {
    ...
    replacementOfCIDCardResubmission.validateCidSrpNoOnly();
    replacementOfCIDCardResubmission.getSpouseReasonDropdownList();
    replacementOfCIDCardResubmission.getCountryDropdownList();
    replacementOfCIDCardResubmission.getDzongkhagDropdownList();
    replacementOfCIDCardResubmission.getGewogDropdownList();
    replacementOfCIDCardResubmission.getVillageDropdownList();
    replacementOfCIDCardResubmission.removeReplacementError();
    replacementOfCIDCardResubmission.getSpouseInformation();
    replacementOfCIDCardResubmission.validateSpouseCountry();
    replacementOfCIDCardResubmission.addSpouseInformation();
    replacementOfCIDCardResubmission.refreshSpouseInformation();
    replacementOfCIDCardResubmission.removeSpouseInformation();
    replacementOfCIDCardResubmission.removeSpouseInformationError();
    replacementOfCIDCardResubmission.validateMaritalStatus();
    replacementOfCIDCardResubmission.validateMotherTongue();
    replacementOfCIDCardResubmission.nextTab();
    replacementOfCIDCardResubmission.previousTab();
    replacementOfCIDCardResubmission.getPresentGewogDropdownList();
    replacementOfCIDCardResubmission.getPresentVillageDropdownList();
    replacementOfCIDCardResubmission.changePresentAddressChange();
    replacementOfCIDCardResubmission.cancelPresentAddressChange();
    replacementOfCIDCardResubmission.addMoreDocuments();
    replacementOfCIDCardResubmission.removeFileRow();
    replacementOfCIDCardResubmission.getIndividualInformationByAppNo();
    replacementOfCIDCardResubmission.saveResubmission();
    replacementOfCIDCardResubmission.getApplicationDetails();
    replacementOfCIDCardResubmission.deleteThisDoc();
    replacementOfCIDCardResubmission.removeErrorClass();
    replacementOfCIDCardResubmission.validateCountryOfBirth();
});
