...
var replacementOfCIDcardApprove = (function () {
     ...
     */
    function _baseURL() {
        return dcrc_lib.baseUrl() + 'replacementOfCIDcardApprove/';
    }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 1) {
                    ...
                    if(res.dto.presentInformationDTO != null){
    ...
    function approveReplacementCID() {
    ...
    function sendBack() {
        $('#btnResubmit').on('click', function () {
            ...
            if (applicationNumber === '') {
                warningMsg(replacementCIDCardMsg.applicationNumberReq);
                return;
            }
    ...
    return {
        ...
        approveReplacementCID: approveReplacementCID,
        reject: reject
    };
})();
...
$(document).ready(function () {
    ...
    replacementOfCIDcardApprove.getIndividualInformationByAppNo();
    replacementOfCIDcardApprove.nextTab();
    replacementOfCIDcardApprove.previousTab();
    replacementOfCIDcardApprove.sendBack();
    replacementOfCIDcardApprove.getApplicationDetails();
    replacementOfCIDcardApprove.approveReplacementCID();
    replacementOfCIDcardApprove.reject();
});