...
var birthRegistration = (function () {
    "use strict";
     ...
     */
    function _baseURL() {
        return dcrc_lib.baseUrl() + 'birthRegistration/';
    }
    ...
    function save() {
        $('#btnSave').on('click', function () {
            $('#birthRegistrationDetailsForm').validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            if (res.status === 1) {
                                successMsgRedirect(res.text, 'birthRegistrationApply');
...
$(document).ready(function () {
   ...
   /* $(".datepicker").datepicker({
    ...
    birthRegistration.nextTab();
    birthRegistration.previousTab();
    birthRegistration.validateCountryOfBirth();
    birthRegistration.validatePlaceOfBirth();
    birthRegistration.getGewogDropdownList();
    birthRegistration.getVillageDropdownList();
    birthRegistration.getFatherDetails();
    birthRegistration.getMotherDetails();
    birthRegistration.getHouseholdDetails();
    birthRegistration.addMoreDocuments();
    birthRegistration.removeFileRow();
    birthRegistration.save();
    birthRegistration.addMultipleFile();
    birthRegistration.removeErrorClass();
